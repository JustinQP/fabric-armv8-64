...
echo "Instantiating smart contract on mychannel"
  peer chaincode instantiate \
    ...
    -v 1.0 \
    -c '{"Args":[]}' \
    -P "OR('Org1MSP.member','Org2MSP.member','Org3MSP.member','Org4MSP.member')" \
    --tls \
...
echo "The transaction is sent to all of the peers so that chaincode is built before receiving the following requests"
  peer chaincode invoke \
    ...
    --peerAddresses peer1.org4.example.com:14051 \
    --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt \
    ...
    --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/tls/ca.crt \
    ...
    --tlsRootCertFiles /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/org4.example.com/peers/peer1.org4.example.com/tls/ca.crt
sleep 15
